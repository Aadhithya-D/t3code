...
The Usage page combines Codex, Claude Code, Grok Build, and Kiro CLI activity from your connected
...
- **Grok Build** — persisted session updates under `~/.grok/sessions`
...
published model rates applied to the recorded tokens. Grok Build totals come from persisted
session updates. Interactive turns that never wrote a completed-turn record will not appear.
